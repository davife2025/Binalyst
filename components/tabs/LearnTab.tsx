...
const LESSONS = [
  { icon: '📊', title: 'Spot Trading Basics',     level: 'beginner',     prompt: 'Explain Binance Spot trading: order types (market, limit, stop-limit), how to read the order book, trading fees, and tips for beginners. Use examples.' },
  ...
  { icon: '🌾', title: 'Launchpool Farming',       level: 'beginner',     prompt: 'How does Binance Launchpool work? How do I stake BNB or FDUSD to earn new tokens? What are the risks? Give step-by-step instructions.' },
  { icon: '🪂', title: 'HODLer Airdrops',          level: 'intermediate', prompt: 'What are Binance HODLer airdrops? How do I qualify? What is Binance Alpha? Walk me through how to claim step by step.' },
  { icon: '🔄', title: 'DCA & Auto-Invest',        level: 'beginner',     prompt: 'Explain dollar-cost averaging (DCA) for crypto. How does Binance Auto-Invest work? What are the best practices and how to set it up?' },
  { icon: '🔗', title: 'On-Chain Analysis',        level: 'advanced',     prompt: 'Explain on-chain analysis for crypto trading: exchange inflows/outflows, whale wallets, SOPR, MVRV. How can I use this to trade better on Binance?' },
  { icon: '📈', title: 'Technical Analysis',       level: 'intermediate', prompt: 'Teach me practical TA for crypto: support/resistance, RSI, MACD, Bollinger Bands. How do I apply these on Binance charts?' },
  { icon: '🛡️', title: 'Risk Management',          level: 'beginner',     prompt: 'Explain crypto risk management: position sizing, stop-losses, portfolio allocation. What are the golden rules for trading on Binance safely?' },
  { icon: '💰', title: 'Binance Earn',             level: 'beginner',     prompt: 'What are all the Binance Earn products? Simple Earn, Flexible, Locked, ETH staking, LDUSDT. Compare them and tell me which is best for different goals.' },
]
...
export default function LearnTab() {
  const [messages, setMessages] = useState<Msg[]>([{
    id: '0', role: 'assistant',
    content: "Hey! I'm your Binalyst crypto tutor. Click a lesson above to start learning, or ask me anything about crypto, Binance products, trading, or DeFi. I'll explain it clearly with real examples. 🎓",
  }])
      ...
      <div className="rounded-xl overflow-hidden" style={{ border: '1px solid var(--border)' }}>
        ...
        <div className="flex gap-2 px-4 py-3 border-t" style={{ borderColor: 'var(--border)', background: 'var(--bg2)' }}>
          <input ref={inputRef} value={input} onChange={e => setInput(e.target.value)}
            ...
            disabled={streaming} placeholder="Ask me anything about crypto or Binance..."
