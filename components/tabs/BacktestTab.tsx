...
const SYMBOLS   = ['BTC', 'ETH', 'BNB', 'SOL', 'ADA', 'AVAX', 'DOT', 'LINK', 'MATIC', 'DOGE']
const LOOKBACKS = [
    ...
    <div className="max-w-5xl mx-auto px-6 py-6 flex flex-col gap-6">
      ...
      {result && (
        <>
          ...
          {/* Drawdown warning for competition */}
          {result.maxDrawdown >= 25 && (
            <div className="rounded-xl px-4 py-3"
              ...
              <span className="mono text-xs font-bold" style={{ color: 'var(--red)' }}>
                ⚠ Max drawdown {fmt(result.maxDrawdown)}% exceeds competition safety threshold (25%).
                Reduce position size or tighten stop conditions before deploying live.
              </span>
            </div>
          )}
