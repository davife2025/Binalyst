...
Buy BNB with 7% near support when RSI is below 35.
Sell BNB near resistance when RSI is above 65.
          ...
          <div className="rounded-md p-4" style={{ background: 'rgba(240,185,11,0.06)', border: '1px solid rgba(240,185,11,0.15)' }}>
            ...
            <div className="grid gap-1" style={{ gridTemplateColumns: '1fr 1fr' }}>
              {[
                ...
                <div key={rule} className="mono text-[10px]" style={{ color: 'var(--text2)' }}>{rule}</div>
              ))}
            </div>
          </div>
          ...
          {!agentConfig.dryRun && agentConfig.autonomousMode && (
            <div className="rounded-md p-4"
              ...
              <div className="mono text-[10px] mt-1" style={{ color: 'var(--text2)' }}>
                ...
                Ensure guardrails are correct and you have sufficient BNB for gas.
              </div>
            </div>
          )}
